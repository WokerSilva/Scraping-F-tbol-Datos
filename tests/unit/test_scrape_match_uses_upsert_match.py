...
class Parser:
    def parse_match(self, html, **kwargs):
        class M:
            ...
            payload = {"source_match_id": "2026239018", "competition_slug": "clausura_mexico", "round_label": "JORNADA1", "metadata": {}, "stats_json": {}, "events_json": {}}
        return M()

class Matches:
    def __init__(self): self.called = False
    def upsert_match(self, **kwargs): self.called = True; return 1
...
def test_execute_match_url_uses_upsert_match():
    ...
    assert uc.uow.matches.called is True
